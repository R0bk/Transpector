...
export const initEdges = [
    ...
    { id: 'we-b1', source: 'we', target: 'blocks.0', },
    // { id: 'e5', source: 'we', target: 'blocks.0.query', },
    // { id: 'e6', source: 'we', target: 'blocks.0.key', },
    // { id: 'e7', source: 'we', target: 'blocks.0.value', },
    { id: 'e8', source: 'we', target: 'blocks.0.hook_resid_mid', },
    { id: 'e9', source: 'pos', target: 'blocks.0', },
    // { id: 'e10', source: 'pos', target: 'blocks.0.key', },
    // { id: 'e11', source: 'pos', target: 'blocks.0.value', },
    { id: 'e12', source: 'pos', target: 'blocks.0.hook_resid_mid', },
];